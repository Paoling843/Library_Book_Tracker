<x-app-layout>
    <x-slot name="header">
        <style>
            ...
            .lib-header-title { font-family: 'Playfair Display', Georgia, serif; font-size: 1.5rem; font-weight: 600; padding-inline: 150px; background: #f9f4ee; color: #2c1810; }
            .lib-header-subtitle { font-family: 'Crimson Pro', Georgia, serif; font-style: italic; font-size: 0.875rem; padding-inline: 150px; background: #f9f4ee; color: #8a7660;  }
